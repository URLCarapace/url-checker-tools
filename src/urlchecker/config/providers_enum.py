...
class ProviderConfigTemplate:
    ...
    def get_yara_config() -> Dict[str, Any]:
        ...
        project_root = config_file.parent.parent.parent.parent  # Go up from url_checker/src/urlchecker/config/
        default_rules_dir = project_root / "data/yara" #set default rules directory relative to project root url_checker/
